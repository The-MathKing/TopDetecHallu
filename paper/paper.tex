...
\bottomrule
\end{tabular}
\caption{Classification performance for hallucination detection across different feature sets. The main feature sets (MSP, 0D, 1D, Combined) use 10-fold cross validation. The SelfCheckGPT baseline and the 1.5B generalization tests use 5-fold cross validation. 0D persistent homology provides the strongest signal, significantly outperforming the MSP baseline.}
\label{tab:results}
\end{table}
